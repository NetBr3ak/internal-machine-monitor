...
```powershell
cd c:\Users\Q\Desktop\hackaton\production-simulator
```
...
**4 Maszyny:**
- **CNC-01, CNC-02** - Szybkie frezarki (obróbka precyzyjna)
- **Assembly-Line A** - Linia montażowa (spawanie, złożenia)
...
1. **[0:00-0:30]** Otwarcie aplikacji, pokazanie interfejsu
   - "To jest symulator 4 maszyn produkcyjnych z hal ELPLC"
...
3. **[1:00-2:00]** Obserwacja symulacji
   - "CNC-01 i CNC-02 przetwarzają wariatory (Critical priority)"
   - "Assembly-A montuje baterie e-bike"
...
2. Oblicz ETA = czas_pozostały + kolejka + nowe_zadanie
3. Wybierz maszynę z najmniejszym ETA
4. Bonus 10% dla preferowanych maszyn
```
